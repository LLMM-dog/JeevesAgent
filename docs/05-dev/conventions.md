...
见 [../04-frontend/architecture.md](../04-frontend/architecture.md#为什么不用-camelcase)。规则复述：
...
见 [../02-data/files.md](../02-data/files.md#什么进-git什么不进)。
...
| 改了什么 | 必须同步 |
| --- | --- |
| 数据库表结构 | [../02-data/schema.md](../02-data/schema.md) 或 schema-2.md |
| SSE 事件名或字段 | [../03-api/sse-events.md](../03-api/sse-events.md) **+ 前端 switch** |
| 接口路径、请求/响应结构 | [../03-api/](../03-api/) 对应文件 |
