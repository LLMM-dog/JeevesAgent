...
空串 = 用户可见主线；有值 = 该智能体私有线。见 [../architecture/agents.md](../architecture/agents.md#智能体的记忆线)。
...
理由见 [../architecture/context.md](../architecture/context.md#引用内容不落进-messages-的持久内容)：内容按需重读，历史记录小，文件改了自动看到新版。
